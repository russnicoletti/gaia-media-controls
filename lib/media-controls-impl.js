...
MediaControlsImpl.prototype.addEventListeners = function() {
  ...
  this.slider.addEventListener('slider-moved', this);
};
...
MediaControlsImpl.prototype.handleEvent = function(e) {
  ...
  switch(e.type) {
    ...
    case 'loadedmetadata':
      ...
      this.slider.setMax(this.mediaPlayer.duration);
    ...
    case 'slider-moved':
      console.log('got \'slider-moved\' event, value: ' + e.detail);
      this.seekBy(e.detail);
...
MediaControlsImpl.prototype.movePlayHead = function() {
  this.slider.setValue(this.mediaPlayer.currentTime);
};
